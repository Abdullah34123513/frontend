              ...
              <CardContent className="p-4 sm:p-6">
                <div className="flex items-center gap-2 mb-6">
                  ...
                  <Link to={getLocalizedPath("/trending")}>
                    <h3 className="font-bold text-gray-900 hover:text-[#22ae4b] transition-colors cursor-pointer">{t.home.trending_now}</h3>
                  </Link>
                </div>

                <div className="space-y-3">
                  {[
                    { name: "Asian Fusion", count: "2.4k recipes", trend: "+12%", link: "/category/asian" },
                    { name: "Healthy Bowls", count: "1.8k recipes", trend: "+8%", link: "/category/healthy" },
                    { name: "Quick Meals", count: "3.2k recipes", trend: "+15%", link: "/trending" },
                    { name: "Desserts", count: "1.5k recipes", trend: "+5%", link: "/category/dessert" }
                  ].map((category, index) => (
